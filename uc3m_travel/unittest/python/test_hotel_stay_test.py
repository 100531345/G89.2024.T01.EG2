...
class TestRequestReservation(TestCase):
    ...
    def test_request_TC12(self):
        self.assertRaisesRegexp(HotelManagementException,"bad name surname", request_reservation, 5555555555554444, "12345678Z",
    ...
    def test_request_TC15(self):
        self.assertRaisesRegexp(HotelManagementException,"bad phone number",
                          request_reservation, 5555555555554444, "12345678Z", "JOSE LOPEZ", "ABC", "SINGLE", "01/07/2024",
                                              2)
    ...
    def test_request_TC22(self):
        self.assertRaisesRegexp(HotelManagementException,"bad room type",
                          request_reservation, 5555555555554444, "12345678Z", "JOSE LOPEZ", 911234567, 123, "01/07/2024",
                                              2)
