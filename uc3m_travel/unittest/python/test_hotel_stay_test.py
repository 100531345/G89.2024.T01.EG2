...
class TestRequestReservation(TestCase):
    ...
    def test_request_TC2(self):
        self.assertRaises(hotel_management_exception,
    ...
    def test_request_TC12(self):
        self.assertRaises(hotel_management_exception, request_reservation(5555555555554444, "12345678Z",
    ...
    def test_request_TC14(self):
        self.assertEquals(hotel_management_exception,
