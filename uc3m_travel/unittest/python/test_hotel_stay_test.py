from uc3m_travel import room_reservation, HotelManagementException
...
class TestRequestReservation(TestCase):
    ...
    def test_request_TC19(self):
        self.assertEquals(True, room_reservation(5555555555554444, "12345678Z", "JOSE LOPEZ", 911234567, "DOUBLE",
                                                    "01/07/2024", 2))

    def test_request_TC20(self):
        self.assertEquals(True, room_reservation(5555555555554444, "12345678Z", "JOSE LOPEZ", 911234567, "TRIPLE",
                                                    "01/07/2024", 2))
